...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='phoenix2014',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='/home/zyb/disk/glm/RWTH/phoenix2014-release/phoenix-2014-multisigner',
                        help='path to the dataset')
    parser.add_argument('--annotation-prefix', type=str, default='annotations/manual-128/{}.corpus.csv',
